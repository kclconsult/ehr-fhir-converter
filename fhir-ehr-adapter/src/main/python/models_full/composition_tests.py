...
class CompositionTests(unittest.TestCase):
    ...
    def implComposition1(self, inst):
        ...
        self.assertEqual(inst.section[1].text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>History of family member diseases - not available</p></div>")
        ...
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>Consultation note for Henry Levin the 7th</p><p>Managed by Good Health Clinic</p></div>")
