...
class ListTests(unittest.TestCase):
    ...
    def implList1(self, inst):
        ...
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>Add hydroxocobalamin</p><p>Cancel Morphine Sulphate</p></div>")
    ...
    def implList2(self, inst):
        ...
        self.assertEqual(inst.status, "current")
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\"><img src=\"#image\" alt=\"Family history diagram for Annie Proband\"/></div>")
        self.assertEqual(inst.text.status, "generated")
    ...
    def implList3(self, inst):
        ...
        self.assertEqual(inst.mode, "snapshot")
        self.assertEqual(inst.status, "current")
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>Patient Admission Waitoing list</p></div>")
        self.assertEqual(inst.text.status, "generated")
    ...
    def implList4(self, inst):
        ...
        self.assertEqual(inst.mode, "snapshot")
        self.assertEqual(inst.status, "current")
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>The patient is not on any medications</p></div>")
        self.assertEqual(inst.text.status, "generated")
