...
class OperationOutcomeTests(unittest.TestCase):
    ...
    def implOperationOutcome1(self, inst):
        ...
        self.assertEqual(inst.text.div, '<div xmlns=\"http://www.w3.org/1999/xhtml\"> <p>Error parsing resource XML (Unknown Content &quot;label&quot; @ /Patient/identifier/label)</p></div>')
    ...
    def implOperationOutcome2(self, inst):
        ...
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>Additional information may be available using the Break-The-Glass Protocol</p></div>")
        self.assertEqual(inst.text.status, "generated")
    ...
    def implOperationOutcome3(self, inst):
        ...
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>The &quot;name&quot; parameter has the modifier &quot;exact&quot; which is not supported by this server</p></div>")
        self.assertEqual(inst.text.status, "generated")
    ...
    def implOperationOutcome4(self, inst):
        ...
        self.assertEqual(inst.issue[0].severity, "error")
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>SQL Link Communication Error (dbx = 34234)</p></div>")
    ...
    def implOperationOutcome5(self, inst):
        ...
        self.assertEqual(inst.issue[0].severity, "error")
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>W is not a recognized code for Gender.</p></div>")
        self.assertEqual(inst.text.status, "additional")
    ...
    def implOperationOutcome6(self, inst):
        ...
        self.assertEqual(inst.issue[0].severity, "information")
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>All OK</p></div>")
        self.assertEqual(inst.text.status, "additional")
