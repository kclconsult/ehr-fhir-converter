...
class OrganizationTests(unittest.TestCase):
    ...
    def implOrganization2(self, inst):
        ...
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>Acme Corporation, Proud member of the pharma industry</p></div>")
        self.assertEqual(inst.text.status, "generated")
    ...
    def implOrganization7(self, inst):
        ...
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>Good Health Clinic</p></div>")
        self.assertEqual(inst.text.status, "generated")
    ...
    def implOrganization9(self, inst):
        ...
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>XYZ Insurance</p></div>")
        self.assertEqual(inst.text.status, "generated")
