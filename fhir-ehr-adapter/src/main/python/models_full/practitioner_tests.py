...
class PractitionerTests(unittest.TestCase):
    ...
    def implPractitioner4(self, inst):
        ...
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>Harold Hippocrates, MD</p></div>")
        self.assertEqual(inst.text.status, "generated")
    ...
    def implPractitioner7(self, inst):
        ...
        self.assertEqual(inst.role[0].code.coding[0].code, "RP")
        self.assertEqual(inst.role[0].code.coding[0].system, "http://hl7.org/fhir/v2/0286")
        self.assertEqual(inst.role[0].identifier[0].system, "http://example.org/role-identifier")
        self.assertEqual(inst.role[0].identifier[0].value, "52")
        self.assertEqual(inst.role[0].period.end.date, FHIRDate("2012-03-31").date)
        self.assertEqual(inst.role[0].period.end.as_json(), "2012-03-31")
        self.assertEqual(inst.role[0].period.start.date, FHIRDate("2012-01-01").date)
        self.assertEqual(inst.role[0].period.start.as_json(), "2012-01-01")
        self.assertEqual(inst.role[0].telecom[0].system, "email")
        self.assertEqual(inst.role[0].telecom[0].value, "dr.adam.careful@example.org")
        self.assertEqual(inst.role[1].period.start.date, FHIRDate("2012-01-01").date)
        self.assertEqual(inst.role[1].period.start.as_json(), "2012-01-01")
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>Dr Adam Careful is a Referring Practitioner for Acme Hospital from 1-Jan 2012 to 31-Mar2012</p></div>")
        self.assertEqual(inst.text.status, "generated")
    ...
    def implPractitioner9(self, inst):
        ...
        self.assertEqual(inst.role[0].code.coding[0].code, "224565004")
        self.assertEqual(inst.role[0].code.coding[0].display, "Renal nurse")
        self.assertEqual(inst.role[0].code.coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.role[0].specialty[0].coding[0].code, "9632001")
        self.assertEqual(inst.role[0].specialty[0].coding[0].display, "Nursing procedure")
        self.assertEqual(inst.role[0].specialty[0].coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.telecom[0].system, "phone")
        self.assertEqual(inst.telecom[0].use, "work")
    ...
    def implPractitioner10(self, inst):
        ...
        self.assertEqual(inst.role[0].code.text, "Primary Surgon")
        self.assertEqual(inst.role[0].specialty[0].text, "Orthopedic")
