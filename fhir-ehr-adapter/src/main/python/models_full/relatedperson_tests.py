...
class RelatedPersonTests(unittest.TestCase):
    ...
    def implRelatedPerson2(self, inst):
        ...
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\">Sarah Abels</div>")
        self.assertEqual(inst.text.status, "generated")
    ...
    def implRelatedPerson4(self, inst):
        ...
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\">Ariadne Bor-Jansma</div>")
        self.assertEqual(inst.text.status, "generated")
