...
class RiskAssessmentTests(unittest.TestCase):
    ...
    def implRiskAssessment4(self, inst):
        ...
        self.assertEqual(inst.status, "final")
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>Moderate risk of permanent weakness of the left arm, but otherwise no permanent disability</p></div>")
        self.assertEqual(inst.text.status, "additional")
