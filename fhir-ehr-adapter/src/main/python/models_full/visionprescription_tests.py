...
class VisionPrescriptionTests(unittest.TestCase):
    ...
    def implVisionPrescription2(self, inst):
        ...
        self.assertEqual(inst.status, "active")
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>OD -2.00 SPH         +2.00 add    0.5 p.d. BD</p><p>OS -1.00 -0.50 x 180 +2.00 add    0.5 p.d. BU</p></div>")
        self.assertEqual(inst.text.status, "generated")
